...
## Phạm vi
**Trong scope**: severity-aware intra-slice cho K xe URLLC same-cell (K∈{1,3}); **single-cell** UMi 300m @ Bạch Mai; sweep tuần tự **3 solver × K∈{1,3}** (PPO, TD3, SAC → Table I/II); pipeline 3 pha (Mô hình → Tối ưu → Giải). Luận án.
