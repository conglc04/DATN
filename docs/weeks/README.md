# Kế hoạch từng tuần — PA-CHRL-PPO (W01–W24)
...
> **Pipeline 3 pha**: Mô hình hệ thống → Bài toán tối ưu (CMDP) → 3 solver (PA-CHRL-PPO, TD3-Lag, SAC-Lag) giải + thực nghiệm sweep K∈{1,3}.
...
| [W20](W20_pha3_e2_severity_headline.md) | 3 | **TD3-Lag K=1** | **3C** |
| [W21](W21_formulation_completeness.md) | 3 | **TD3-Lag K=3** (severity + intra-slice) | **3D** |
| [W22](W22_sac_k1.md) | 3 | Code SAC-Lag (B7, NEW) + **SAC-Lag K=1** | **3E** |
| [W23](W23_sac_k3.md) | 3 | **SAC-Lag K=3** + Table I/II compilation (3 solver × K∈{1,3}) | **3F** |
...
- **Thứ tự**: PPO K=1 (W18) → PPO K=3 (W19) → TD3-Lag K=1 (W20) → TD3-Lag K=3 (W21) → SAC-Lag K=1 (W22) → SAC-Lag K=3 (W23).
...
## Solvers (3 — PA-CHRL-PPO + 2 sibling off-policy baselines)
| Solver | Họ | Ghi chú |
|---|---|---|
...
| **SAC-Lag** | off-policy SAC + Lagrangian (max-entropy stochastic actor) | [Haarnoja 2018 SAC + arXiv:1812.05905] — code mới (B7, W22) |
