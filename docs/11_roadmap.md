...
## Critical path
B1 (refs) là cổng cho toàn bộ formulation; B5 (code K≥2 + assert obs 58) là cổng cho cả 6 tuần sweep W18–W23; W23 (Table I/II, 3 solver × K∈{1,3}) = headline. SUMO/OSM (B3) là hạ tầng GPS cho mobility (W15), KHÔNG phải eval harness của sweep W18–W23. **E3/E4 → future work**, KHÔNG còn trên critical path.
